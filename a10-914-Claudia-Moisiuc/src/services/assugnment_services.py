...
class AssignmentService:
    ...
    def random_data(self):
        ...
        ai = ['write an essay on the topic: current situation', 'write an essay on the topic: jobs',
              'write an essay on the topic: clothes', 'write an essay on the topic: news',
              'write an essay on the topic: sports', 'write an essay on the topic: where you are living',
              'write an essay on the topic: the future', 'write an essay on the topic: how you spend your free time',
              'write an essay on the topic: music', 'write an essay on the topic: movies',
              'write an essay on the topic: food', 'write an essay on the topic: books',
              'write an essay on the topic: TV', 'write an essay on the topic: travel',
              'write an essay on the topic: hobbies', 'write an essay on the topic: children',
              'write an essay on the topic: pets', 'write an essay on the topic: restaurants',
              'write an essay on the topic: movies', 'write an essay on the topic: food',
              'write an essay on the topic: books', 'write an essay on the topic: music',
              'write an essay on the topic: movies', 'write an essay on the topic: food',
        ...
        for i in range(20):
            ...
            self.__repository.__add__(a)
        self.__repository.filter_deadline()
    ...
    def sort(self):
        self.__repository.sort_assignment()
