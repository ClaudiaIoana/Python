...
from src.services.undo_service import UndoObject
...
class UI:
    ...
    def ui_update_student(self):
        ...
        if option == 'n':
            ...
            self.__undo_service.register_operation(UndoObject(
                lambda: self.__student_service.update(idd, old_name, None), lambda: self.__student_service.update(idd,
                                                                                                                  new,
                                                                                                                  None))
            )
    ...
    def grading(self):
        ...
        for ids in range(0, n):
            if database[ids].student_id == sid and database[ids].grade is None:
